        ...
        if ($action === 'add_user') {
            ...
            try {
                ...
                if ($result->fetch_assoc()) {
                    ...
                    $_SESSION['flash_message'] = 'User details successfully updated!';
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-grid">
                         <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="calculated_days">Financial year</label>
                                <input type="text" id="calculated_days" class="form-control" readonly>
                            </div>
                        </div>

                      <div class="form-actions">
                            <button type="submit" class="btn btn-primary">Add new Financial year</button>
